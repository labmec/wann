...
ecc = 0; // Eccentricity of the wellbore (0 <= ecc <= 0.5)
...
Transfinite Line {l13,l14,l15,l16,l17,l18,l19,l20} = h_div Using Progression p_res; // Diagonal lines of the near-well region
Transfinite Line {1, 2, 3, 4, 7, 9, 11, 12} = r_div; // Circles of the heel and toe
Transfinite Line {l5,l6,l7,l8,l9,l10,l11,l12} = r_div; // Lines of the near-well region (close to heel and toe)
...
Physical Volume("volume_reservoir",110) = Volume "*";
